...
- AI review uses PR diff + `AI/function.md` only. The reviewer flags issues (no direct fixes) across: spec alignment, security, type safety, error handling, CSV IO, readability/maintainability, and test additions.
